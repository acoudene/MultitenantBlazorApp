...
using Multitenant.Configuration.Domaining;

namespace Multitenant.Configuration.Helpers;
...
public static class UriExtensions
{
  ...
  {
    if (!uri.IsAbsoluteUri) throw new ArgumentException(nameof(uri.IsAbsoluteUri));
